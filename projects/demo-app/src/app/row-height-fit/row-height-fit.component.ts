...
export class KtdRowHeightFitComponent implements OnInit {
    ...
    gridContainerElementRef: ElementRef<HTMLDivElement>;
    ...
    ngOnInit() {
        this.gridHeight =
            this.gridContainerElementRef.nativeElement.getBoundingClientRect().height;
        ...
        this.resizeSubscription = merge(
            ...
            .subscribe(() => {
                const newHeight =
                    this.gridContainerElementRef.nativeElement.getBoundingClientRect()
                        .height;
                if (this.gridHeight !== newHeight) {
                    this.gridHeight =
                        this.gridContainerElementRef.nativeElement.getBoundingClientRect().height;
                } else {
                    // If grid height is the same, resize ii in case only the width has changed.
                    this.grid.resize();
                }
            });
    }
